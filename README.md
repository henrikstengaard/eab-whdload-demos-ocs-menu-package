# EAB WHDLoad Demos OCS Menu Package

EAB WHDLoad Demos OCS Menu package contains menus for AGS2 and iGame with screenshots and details for all OCS demos currently available in Retroplay's WHDLoad packs at English Amiga Board. Menus, screenshots and details are generated using powershell scripts and data files from https://github.com/henrikstengaard/amiga-whdload-game-scripts.

Screenshots and details for all OCS demos are based on Retroplay's WHDLoad packs downloaded September 28th 2021.
...
EAB WHDLoad Demos OCS Menu package contains following features:

- Arcade Game Selector 2 v2020-04-14, https://github.com/MagerValp/ArcadeGameSelector.
- Arcade Game Selector 2 preconfigured menu with screenshots at resolution 320x128 and 12 colors and demo details.
...
EAB WHDLoad Demos OCS Menu package can be installed on any Amiga with Workbench 3.1 (or better) and about 24MB free space on a harddrive for installation.

For EAB WHDLoad Demos OCS Menu package to work properly, it requires following applications and libraries are installed:
...
Download latest release from https://github.com/henrikstengaard/eab-whdload-demos-ocs-menu-package/releases and copy it to HstWB Installer "packages" directory, which typically is "c:\Program Files (x86)\HstWB Installer\Packages".

Installation through HstWB Installer will install and configure EAB WHDLoad Demos OCS Menu package using defined assigns.

## Assigns

Installation of EAB WHDLoad Demos OCS Menu package requires and uses following assigns:
...
EAB WHDLoad Demos OCS Menu package will automatically update SYSTEMDIR:S/User-Assign, SYSTEMDIR:S/Assign-Startup or SYSTEMDIR:S/Startup-Sequence with following assign:
...
Screenshots of EAB WHDLoad Demos OCS Menu package.
